...
if __name__ == '__main__':
    ...
    end_point = 'https://yxp44313.live.dynatrace.com/api/v2/metrics/ingest'
    default_endpoint = 'http://localhost:14499/metrics/ingest'
    token = 'dt0c01.CSWCVVGBBZJLRK7NGPTXZX5X.EHEFALQQ2GVJACDFWVJELDRVCWXKALZDZK6U7WLQPVN5GTKG5B7EHYDDJE5VI6BG'
    logger.debug("setting up global OpenTelemetry configuration.")
    _metrics.set_meter_provider(MeterProvider(
        metric_readers=[PeriodicExportingMetricReader(
            export_interval_millis=5000,
            exporter=DynatraceMetricsExporter(endpoint_url=end_point,
                                              api_token=token,
                                              prefix="otel.python",
